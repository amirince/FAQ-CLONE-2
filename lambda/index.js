...
//Code for getting user info
const FULL_NAME_PERMISSION = "alexa: :profile:name: read";
const EMAIL_PERMISSION = "alexa::profile: email: read";
const MOBILE_PERMISSION = "alexa::profile:mobile number: read";
//End code for user info

//Code for connecting to firebase 
const firebase = require('firebase/app');
require('firebase/database');

const config = {
    apiKey: "AIzaSyAPC1j9j3yt0lHnvf_EZzXVY9CP9PE2pIw",
    authDomain: "alexa-voice-faq-b1300.firebaseapp.com",
    databaseURL: "https://alexa-voice-faq-b1300-default-rtdb.firebaseio.com",
    projectId: "alexa-voice-faq-b1300",
    storageBucket: "alexa-voice-faq-b1300.appspot.com",
    messagingSenderId: "502277787287",
    appId: "1:502277787287:web:fb47ca62175aa58c13a3d2",
    measurementId: "G-52KK90CHZM"
};
...
const QuestionTenIntentHandler = {
    ...
    const { requestEnvelope, serviceClientFactory, attributesManager } = handlerInput;
      ...
      console.log("Prior database code");
      //Begin databse implementation
      const userId="123456789"
      firebase.database().goOnline();
      var current= new Date();
      var date=current.toLocaleDateString();
      var time=current.toLocaleTimeString();
      await firebase.database().ref('/FaqTestScore/' + userId).set({
        TIME: time,
        DATE: date,
        FAQScore: FAQScore,
        Name: "Mars"
      });
      console.log("Database stuff in QuestionTenIntent");
      firebase.database().goOffline();
      //End testing databse implementation
      
     
    //Currently breaks the code, needs attention
    //   //User data
    ...
    //   console.log("Cell phone numbers!!!");
...
//         const UserId='123456';
//         let speakOutput = 'I am in the database function';
//         try{
//             firebase.database().goOnline();
//             await database.ref('/UserData/' + UserId).set({
//             Email : 'joanjohn@gmail.com',
//             FaqScore : '21',
//             UserName: 'Name'
//         })
//         firebase.database().goOffline();
...
//             speakOutput = `There was a problem adding to database`
//         }
